...
var snd = new Audio("Game-Menu_Looping.mp3");
var gamewon = new Audio("gamewon.mp3");
...
var background = ["super-mario", "ben10", "shinchan", "doraemon"];
...
function shuffleBoard() {
    ...
    var sixteen = 15;
    /**  Logic to play game  music in the background when the puzzle is started */
    snd.play();
    snd.currentTime=0;
...
function checkIfWon() {
    if (ids.toString() == shuffled.toString()) { // Test the image, time and number of turns by swapping == to !=
        ...
        /**  Logic to play game won music in the background when the puzzle is complete */
        gamewon.play();
